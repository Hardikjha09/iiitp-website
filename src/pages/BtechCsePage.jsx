...
const BtechCsePage = () => {
  ...
  const cseFaculty = useMemo(() => {
    return Object.entries(facultyDetails).filter(([id, f]) => {
      if (id === 'bhupendra-singh') return false;
      return f.department === 'CSE';
    }).map(([id, f]) => {
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                ...
                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-5 py-3 rounded-lg border border-white/20">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-lg">326 Students</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mt-12 w-full">
            <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="bg-blue-50/50 dark:bg-gray-800/50 md:w-1/3 p-8 flex flex-col items-center text-center border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-800">
                <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-md mb-6">
                  <img
                    src="/assets/faculty_photos/bhupendrasingh.jpg"
                    alt="Dr. Bhupendra Singh"
                ...
                <div className="w-full space-y-1.5 flex flex-col items-center text-center">
                  <div>
                    <Link 
                      to="/people/faculty/bhupendra-singh"
                  ...
                  <div className="flex items-center justify-center text-sm text-gray-700 dark:text-gray-300 w-full">
                    <span>
                      +91 9673095708<br />+91 9325302119
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="md:w-2/3 p-8 md:p-10 flex flex-col justify-center relative">
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300 relative z-10 leading-relaxed text-justify">
                  <p>
                    The Department of Computer Science and Engineering serves as a hub for innovation, computing excellence, and technological advancement at IIIT Pune. Our academic programmes are designed with a strong emphasis on focusing on fundamentals while integrating experiential learning, project-based learning, and hands-on exposure to contemporary technologies. Students are encouraged to explore diverse areas including Artificial Intelligence, Data Science, Cybersecurity, Machine Learning, Software Engineering, and Intelligent Systems through coursework, research, and innovation-driven projects.
                  </p>
                  <p>
                    The department actively promotes collaborative research and industry engagement, providing opportunities for internships, technical mentoring, and participation in real-world problem-solving initiatives. Through a culture of innovation, inquiry, and continuous learning, we strive to nurture competent professionals, researchers, entrepreneurs, and technology leaders capable of creating meaningful impact in society.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-end mb-8 border-b pb-4 border-gray-200 dark:border-gray-800">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-2">
                  Meet our esteemed faculty in the Department of Computer Science and Engineering.
                </p>
              </div>
            </div>
